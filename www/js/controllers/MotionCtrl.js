(function() {
    ...
    angular
        .module('starter')
        .controller('MotionCtrl', MotionCtrl);

    MotionCtrl.$inject = ['$scope', '$stateParams', '$timeout', 'ionicMaterialInk', 'ionicMaterialMotion'];

    function MotionCtrl($scope, $stateParams, $timeout, ionicMaterialInk, ionicMaterialMotion) {
        var vm = this;
